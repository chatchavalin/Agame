...
(function () {
  ...
  const LIBRARY = {
    BG_AI: [
      ...
      "ปุญนับนิ้ว... 'Bingo ครั้งที่เท่าไหร่แล้วนะ?'",
    ...
    AI_PASS: [
      ...
      "ปุญ: 'เครื่องคิดเลขยัง error ได้ AI ก็ pass ได้' 555",
    ],
    OPP_PASS: [
      ...
      "ปุญ: 'pass = ยอมแพ้ ใช่มั้ย? ใช่มั้ย?!' 😏",
      "ปุญโดนฟรีซรึเปล่า ทำไม pass! 🥶",
    ...
    HIGH_SCORE_PLAY: [
      ...
      "ปุญเปิดเครื่องคิดเลข... 'คะแนนจริงเหรอ?! ตกใจ!'",
    ],
    NEUTRAL: [
      "ยังเล่นอยู่นะ",
      "Next move incoming...",
    ...
    STALLING: [
      ...
      "ปุญกระตุกเทียน2: 'ของฉันยังเล่นเร็วกว่าเลย'",
      "ปุญ: 'ตันแล้วบอกได้นะ ไม่ต้องเขิน'",
      "เทียน1 พึมพำ: 'หา pattern เจอยังคะ?'",
      "เทียน1 ขยับเก้าอี้ไปมา รอนาน",

      // — Mixed character commentary —
      "ทั้งโต๊ะมองเธออยู่นะ — โค้ชตี๋ พีซ ฟ้า เทียน1 เทียน2 จิณตา เพลงรัก ปุญ",
      ...
      "ปุญโดนฟรีซ! ...เอ๊ะ ไม่ใช่ คนเล่นต่างหากที่แข็ง 🥶",
    ],
    ...
    CHALLENGE_BUILDUP: [
      ...
      "ปุญ: 'รอแป๊บ ขอใช้เครื่องคิดเลขก่อน 🤓'",
    ...
    AI_X9_PLAY: [
      ...
      "ปุญ: 'เครื่องคิดเลขยังไม่ทันคำนวณเลย — x9!'",
