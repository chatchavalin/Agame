...
(function () {
  ...
  const LIBRARY = {
    BG_AI: [
      ...
      "อรุษพยักหน้า 'นี่แหละฝีมือสาธิตจุฬา' 😎",
      "สาธิตจุฬา Bingo อีกแล้ว สาธิตองครักษ์ตามให้ทัน! 🔥",
    ...
    BG_OPP: [
      ...
      "อรุษ: 'Bingo ดี... แต่สาธิตจุฬาทำได้ทุกเกม' 😏",
    ...
    LEAD_BIG: [
      ...
      "อรุษ: 'เด็กสาธิตจุฬานำแบบนี้ ปกติ' 💅",
      "สาธิตจุฬานำ สาธิตองครักษ์ตาม สมดุลของจักรวาล 555",
    ...
    BEHIND_100: [
      ...
      "อรุษ: 'ริวจิ สาธิตจุฬาไม่ยอมง่ายๆ สู้!' ...เอ๊ะ ให้กำลังใจเหรอ? 😅",
    ...
    BEHIND_200: [
      ...
      "อรุษ: 'ตามหลังขนาดนี้... เสียชื่อสาธิตจุฬาหมดเลย' 💀",
    ...
    OPP_PASS: [
      ...
      "อรุษ: 'สาธิตจุฬาไม่ pass... เราหาสมการจนเจอ' 🧠",
    ...
    HIGH_SCORE_PLAY: [
      ...
      "อรุษจดสถิติ 'สาธิตจุฬา 50+ อีกแล้ว!' 📊",
    ...
    NEUTRAL: [
      ...
      "พีซแอบดูแป้นเธอ แล้วก็ทำหน้าสงสาร 🥲",
      ...
      "อรุษนั่งดูเงียบๆ... 'สาธิตจุฬากำลังประเมินอยู่' 👀",
    ],
    ...
    STALLING: [
      ...
      "อรุษ: 'เด็กสาธิตจุฬาคิดเร็วกว่านี้อีก' ⚡",
