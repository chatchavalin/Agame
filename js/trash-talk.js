...
(function () {
  ...
  const LIBRARY = {
    BG_AI: [
      ...
      "ริวจิ! Bingo แบบนี้ มนภัทรเห็นคงกลัวเลย 💪",
      "ไจ๋ไจ๋เห็นท่านี้คงต้องกลับไปซ้อมใหม่ 😏",
      "Bingo ระดับนี้ คอปเตอร์ก็ยังต้องยอม ✨",
    ],
    BG_OPP: [
      ...
      "พีซ: 'อืม...โอเค ฟลุคไป' 🙄",
      // — ตัวละคร —
      "เล่นดีนะ ต้นไม้เห็นคงยิ้มเลย 🌳",
      "น้องพัฟเห็นคงจดเทคนิคไว้แล้ว ✍️",
      "น้องรดาเห็นคงวิ่งมาตบมือให้! 👏",
      "ริวจิ Bingo สวยมาก! เอาท่านี้ไปใช้กับกันได้เลย 🎯",
    ...
    LEAD_BIG: [
      ...
      // — ตัวละคร —
      "น้องรดายังเล่นสนุกกว่านี้อีกนะ ลองดูใหม่! 😄",
      "ต้นไม้สอนมาดี นำห่างแบบนี้ไม่มีใครตามทัน 🌳",
      "น้องโอโอเห็นสกอร์นี้คงหัวเราะเลย 555",
      "ริวจิ นำห่างขนาดนี้ แม้แต่กันก็ตามไม่ทัน 🔥",
      "เล่นแบบนี้ไปแข่งกับมนภัทร ชนะแน่ๆ 💪",
    ],
    BEHIND_100: [
      ...
      // — ตัวละคร —
      "ริวจิ ถ้าเจอไจ๋ไจ๋ตอนนี้ต้องสู้แบบนี้แหละ เชื่อสิ 💪",
      "แข่งกับคอปเตอร์ยังพลิกได้ ตรงนี้ก็พลิกได้ 😤",
    ],
    BEHIND_200: [
      ...
      // — ตัวละคร —
      "ริวจิ สู้ตายเหมือนแข่งกับกัน อย่ายอม! 🔥",
    ...
    OPP_PASS: [
      ...
      // — ตัวละคร —
      "น้องพัฟยังหาสมการได้เลยนะ ลองดูอีกทีมั้ย? 😊",
      "น้องโอโอว่า อย่าเพิ่ง pass ลองหาอีกนิดนึง!",
      "ต้นไม้ว่า pass บางทีก็ฉลาดนะ แต่ตาเธอไม่น่าใช่ 🌳",
    ],
    OPP_SWAP: [
      ...
      // — ตัวละคร —
      "น้องรดาว่า swap ก็ไม่เป็นไร หยิบมาใหม่ให้ดีกว่าเดิม! 💪",
      "น้องพัฟเคย swap แล้วได้ Bingo ตาถัดไปเลยนะ 🌟",
    ],
    HIGH_SCORE_PLAY: [
    ...
    NEUTRAL: [
      ...
      "น้องพัฟกำลังเชียร์อยู่นะ สู้ๆ! 💪",
      "ต้นไม้ว่า ใจเย็นๆ คิดให้ดี 🌳",
      "น้องโอโอรอดูตาต่อไป อย่าทำให้ผิดหวังนะ",
      "ริวจิ คิดดีๆ นะ เหมือนตอนแข่งจริงเลย 🧠",
      "ซ้อมแบบนี้ ไจ๋ไจ๋กับคอปเตอร์เจอก็ไม่กลัว 💪",
    ],
    ...
    STALLING: [
      ...
      "น้องพัฟว่า ไม่เป็นไร ค่อยๆ คิด แต่เร็วหน่อยนะ 😅",
      "ต้นไม้ว่า คิดนานไม่เป็นไร แต่อย่าลืมว่ามีเวลาจำกัดนะ 🌳",
      "น้องโอโอหาว... คิดเสร็จยังคะ? 😴",
      "ริวจิ ถ้าแข่งจริง คอปเตอร์กดนาฬิกาไปนานแล้ว ⏱️",
      "ไจ๋ไจ๋เล่นเร็วกว่านี้อีกนะ เร่งหน่อย! 😅",
    ],
